...
function ins_displayInstructions() {
    ...
    document.getElementById('p_instructionText').innerHTML = "Use left and right arrow keys, or A and D keys to move the collector. <br> Collect as many stars as you can without collecting the asteroids. <br> Hold space to increase your speed."
